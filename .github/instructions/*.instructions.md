...
**Target**: ARM64 (Cortex-A72), Linux 6.12, Buildroot 2026.02.x
...
| Issue | Solution |
|-------|----------|
| "Buildroot directory not found" | Run: `git clone https://github.com/buildroot/buildroot.git --branch 2026.02.x --depth 1` |
