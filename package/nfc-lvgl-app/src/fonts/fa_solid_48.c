 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --bpp 4 --size 48 --no-compress --font fa-solid-900.otf --range 63231,61453,61641,61506,61830,61579,61829,62745,61744 --format lvgl -o fa_solid_48.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 6339, .adv_w = 864, .box_w = 54, .box_h = 49, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 7662, .adv_w = 960, .box_w = 60, .box_h = 48, .ofs_x = 0, .ofs_y = -6}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0x35, 0x7e, 0xbc, 0x123, 0x178, 0x179, 0x50c,
    0x6f2
};
